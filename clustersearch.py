...
class ClusterSearch:
    ...
    def searchSend(input_type='user', search_input=[], search_oper='AND', search_type='Q',api_file=None,time_min=0,time_max=30000000000):
        ...
        if search_type == 'Q':
            ...
            msg={'search_tag':search_tag,'search_var':search_input,'search_field':'orig_message','search_oper':search_oper,'time_min':time_min,'time_max':time_max}
            msg=json.dumps(msg)
            msg=bytes(msg, "ascii")
